...
EXEMPT_PATHS = {"/", "/auth/config", "/auth/session", "/ch-watch/run", "/enrich-oneoff/run", "/prequalify/run", "/email/deep-sync/run", "/investor-mine/run", "/investors/gcs-refill/run", "/diag/verify-email", "/diag/source-counts", "/diag/ch-match-audit", "/smartfill/run-by-number", "/email/ooo-backfill", "/admin/stage-rename", "/admin/archive/run", "/admin/backup/export", "/delivery/verify", "/admin/reply-rule/reconcile", "/admin/analytics/ledger-rebuild", "/smartfill/auto/run", "/admin/contacts/sync-from-sends", "/admin/contacts/placeholder-audit", "/admin/ingest/enterprise-ireland", "/admin/outreach/redraft-stale", "/admin/company", "/email/sync/run", "/admin/rescore-fit", "/email/docs/backfill", "/weekly-review", "/admin/identity-audit", "/admin/identity-repair", "/admin/signature-test", "/admin/financials-backfill", "/admin/investors/test-seed", "/admin/investors/recompute-priority", "/admin/investors/gate-audit", "/admin/investors/reply-rule/reconcile"}
