...
COLUMN_MAP = {
    ...
    # Commitments breakdown v2
    "totalactivecommitments": "total_active_commitments_m",
    "totalcommitmentsinpefunds": "total_pe_commitments_m",
    "commitmentsinvcfunds": "num_vc_commitments",
    "totalcommitmentsinvcfunds": "total_vc_commitments_m",
    "soldsecondarycommitments": "sold_secondaries",
    "boughtsecondarycommitments": "bought_secondaries",
...
def parse_investor_file(file_content: bytes, filename: str = "") -> List[Dict]:
    ...
    for _, row in df.iterrows():
        ...
        investors.append({
            ...
            "total_active_commitments_m": _num(get(row, "total_active_commitments_m")),
            "total_pe_commitments_m": _num(get(row, "total_pe_commitments_m")),
            "num_vc_commitments": _int(get(row, "num_vc_commitments")),
            "total_vc_commitments_m": _num(get(row, "total_vc_commitments_m")),
            "sold_secondaries": _clean_str(get(row, "sold_secondaries"))[:5],
            "bought_secondaries": _clean_str(get(row, "bought_secondaries"))[:5],
            "policy_description": _clean_str(get(row, "policy_description"))[:1500],
