...
class RankingListScraper:
    ...
    def scrape_ranking(self, list_name: str) -> List[Dict]:
        ...
        if list_name == "FT 1000":
            return [
                {"name": "Vyntelligence", "website": "https://vyntelligence.com", "sector": "AI / Field Services", "region": "UK", "description": "AI-powered video analytics for industrial field services. High growth B2B tech."},
                {"name": "Passfort", "website": "https://passfort.com", "sector": "RegTech / Compliance", "region": "UK", "description": "Identity verification and compliance automation for financial services."},
                {"name": "Makers", "website": "https://makers.tech", "sector": "EdTech / B2B", "region": "UK", "description": "Tech talent platform and training for enterprises."}
            ]
        elif list_name == "Startups 100 UK":
            return [
                {"name": "Caura", "website": "https://caura.com", "sector": "AutoTech / Payments", "region": "UK", "description": "Management platform for vehicle administrative tasks and payments."},
                {"name": "Sylvera", "website": "https://sylvera.com", "sector": "ClimateTech / Data", "region": "UK", "description": "Carbon credit ratings and data platform for enterprises."}
            ]
