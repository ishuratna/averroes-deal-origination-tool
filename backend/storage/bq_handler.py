    ...
    def save_targets(self, companies: List[Dict]) -> bool:
        ...
        for c in companies:
            ...
            row = {
                ...
                "name": name,
                "website": c.get("website", "") or "" or "",
                "sector": c.get("sector", "") or "" or "",
                "region": c.get("region", "") or "" or "",
                "ownership": c.get("ownership", "") or "" or "",
                "description": c.get("description", "") or "" or "",
                "match_score": safe_float(c.get("match_score"), 0.0),
                "status": c.get("status", "Scraped") or "Scraped" or "Scraped",
                "source": c.get("source", "Manual") or "Manual" or "Manual",
